...
public class Const {
    ...
    public static final UUID BP_UUID_NOTIFY =  UUID.fromString("0000fff1-0000-1000-8000-00805f9b34fb");
    public static final UUID BP_UUID_SERVICE =  UUID.fromString("0000fff0-0000-1000-8000-00805f9b34fb");
    public static final UUID BP_UUID_WRITE =  UUID.fromString("0000fff2-0000-1000-8000-00805f9b34fb");
