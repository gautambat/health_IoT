...
class MultiSelectFormFieldCustom extends FormField<dynamic> {
      ...
      return InkWell(
        ...
        child: InputDecorator(
          decoration: InputDecoration(
            ...
            hintText: hintText,
            labelText: titleText,
            errorText: state.hasError ? ErrorMessages.OPTION : null,
            enabled: true,
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              state.value != null && state.value.length > 0
                ...
                child: Text(
                  hintText,
                  style: BaseStyles.editTextTextStyle2
                ),
              )
            ],
          ),
